...
# --- [Tab 2] HS정보
with tabs[1]:
    # --- 1. 스타일 설정 (반드시 모든 CSS는 st.markdown의 따옴표 안에 있어야 함) ---
    st.markdown("""
        <style>
            /* 모든 테이블의 열 제목(Header) 가운데 정렬 */
            div[data-testid="stDataFrame"] th {
                text-align: center !important;
                background-color: #f8f9fa;
            }
            /* 모든 테이블의 셀 값 가운데 정렬 기본값 (필요시 column_config에서 덮어씀) */
            ...
            /* 통합공고 요령 폰트 10px 강제 적용 */
            .small-font-table div[data-testid="stDataFrame"] td {
                font-size: 10px !important;
                text-align: left !important; /* 요령은 좌측 정렬 */
            }
        </style>
    """, unsafe_allow_html=True)
    # --- 0. 데이터 로드 ---
