...
st.markdown(f"""
    ...
    /* 2. 통합공고 요령 10px 강제 적용 */
    .small-font-table [data-testid="stDataFrame"] [role="gridcell"] div,
    .small-font-table [data-testid="stDataFrame"] [role="gridcell"] span {
...
with tabs[1]:
    ...
    if target_hs_raw != "0000000000":
        ...
        with col_req2:
            ...
            st.dataframe(ex_req.sort_values('법령명'), height=250, se_container_width=True, hide_index=True, column_config=req_config)
