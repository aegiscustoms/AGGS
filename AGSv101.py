...
with tabs[0]:
    ...
    with st.container(border=True):
        ...
        with col_left:
            st.markdown("<p style='font-size: 14px; font-weight: 600; color: #334155;'>물품 이미지</p>", unsafe_allow_html=True)
        ...
        with col_right:
            st.markdown("<p style='font-size: 14px; font-weight: 600; color: #334155;'>상세 물품 명세</p>", unsafe_allow_html=True)
