        ...
        if not uploaded_file and not input_summary:
            ...
            with st.spinner("🔍 지식 베이스 및 통계 조회 중..."):
                try:
                    ...
                    2. 관련 부/류의 주(Note) 규정과 관세율표 해설서 총설 및 호해설 내용을 반드시 검토할 것.
                    3. 통칙 제1호(호의 용어 및 주 규정)를 최우선 적용하고, 제2호부터 제6호까지 논리적으로 순차 적용할 것.
                    4. 만약 예상되는 4단위 호가 경합될 경우, 본질적인 특성을 부여하는 성분/재질/용도/기능/구성요소에 따라 확정할 것.
                    5. 관세청 발간 '산업별 HS 표준해석 지침(반도체, 자동차부품, 이차전지, 디스플레이, 화장품, 직구 100선)'의 논리를 최우선 적용할 것.
                    6. 관세율표 제16부(84, 85류) 및 제17부(87류) 주 규정을 엄격히 해석할 것. 특히 부분품 분류 시 주 제2호 적용 프로세스를 서술할 것.
                    7. 분류 근거 작성 시 "관세율표 제00부 주 제0호"와 같은 전문적 인용구를 사용할 것.
                    """

                    prompt = f"""당신은 30년 경력의 베테랑 관세사입니다. 제공된 정보를 바탕으로 다음 'AI 분석 리포트 양식'에 맞춰 [수석 관세사 분석 지침]에 따라 분석 리포트를 작성하세요. {knowledge_instruction}
